...
do
    ...
    python hyperparameters.py --model="mir" --dataset="seq-cifar100" --n_tasks=$N_TASKS --experiment_name="seq-cifar100" --buffer_size=500 --n_epochs=50 --batch_size=32 --device="cuda:1"
done