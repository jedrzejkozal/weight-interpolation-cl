...
# python main.py --model="clewi" --dataset="seq-tinyimg" --buffer_size=500 --seed=43 --n_tasks=20 --lr=0.1 --n_epochs=100 --run_name="clewi run 1 20 tasks" --experiment_name="seq-tinyimagenet"
# python main.py --model="clewi" --dataset="seq-tinyimg" --buffer_size=500 --seed=44 --n_tasks=20 --lr=0.1 --n_epochs=100 --run_name="clewi run 2 20 tasks" --experiment_name="seq-tinyimagenet"
# python main.py --model="clewi" --dataset="seq-tinyimg" --buffer_size=500 --seed=45 --n_tasks=20 --lr=0.1 --n_epochs=100 --run_name="clewi run 3 20 tasks" --experiment_name="seq-tinyimagenet"
# python main.py --model="clewi" --dataset="seq-tinyimg" --buffer_size=500 --seed=46 --n_tasks=20 --lr=0.1 --n_epochs=100 --run_name="clewi run 4 20 tasks" --experiment_name="seq-tinyimagenet"
# python main.py --model="clewi" --dataset="seq-tinyimg" --buffer_size=500 --seed=47 --n_tasks=20 --lr=0.1 --n_epochs=100 --run_name="clewi run 5 20 tasks" --experiment_name="seq-tinyimagenet"
...
# python main.py --model="clewim" --dataset="seq-cifar100" --buffer_size=2000 --seed=42 --n_tasks=20 --lr=0.1 --interpolation_alpha=0.3 --run_name="clewi with er no first task interpolation_alpha 0.3 buffer size 2000"